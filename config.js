...
module.exports = {
    ...
    ABU: process.env.AUDIO_CAPTION === undefined ? '[CYBER KID]\n INSTA: DRON CYBER' : process.env.AUDIO_CAPTION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By CYBERXKIDD' : process.env.ALL_CAPTION,
    ...
    YAK: process.env.YAK === undefined ? '27 63 819 6983,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
